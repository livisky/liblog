module.exports = [
    ...
    [/^topic\/all\/page\/(\d+)$/,"topic/index?tab=all&page=:1&pagesize=20"],
    [/^topic\/ask\/page\/(\d+)$/,"topic/index?tab=ask&page=:1&pagesize=20"],
    [/^topic\/share\/page\/(\d+)$/,"topic/index?tab=share&page=:1&pagesize=20"],
    [/^topic\/job\/page\/(\d+)$/,"topic/index?tab=job&page=:1&pagesize=20"],
